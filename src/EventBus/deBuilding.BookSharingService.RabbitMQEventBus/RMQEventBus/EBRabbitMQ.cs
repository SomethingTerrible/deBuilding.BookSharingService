...
using deBuilding.BookSharingService.EventBus.Extensions;
...
namespace deBuilding.BookSharingService.RabbitMQEventBus.RMQEventBus
{
	public class EBRabbitMQ : IEventBus, IDisposable
	{
		const string BROKER_NAME = "deBuilding_booksharing";

		private static readonly JsonSerializerOptions s_indentedOptions = new() { WriteIndented = true };
		private static readonly JsonSerializerOptions s_caseInsensitiveOptions = new() { PropertyNameCaseInsensitive = true };

		private readonly IRabbitMQPersistentConnection _persistentConnection;
		private readonly ILogger<EBRabbitMQ> _logger;
		...
		public EBRabbitMQ(IRabbitMQPersistentConnection persistentConnection, ILogger<EBRabbitMQ> logger,
